        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <img src="{{asset($user->image)}}" alt="avatar" class="rounded-circle img-fluid" style="width: 200px; height: 200px;">
            </div>
          </div>
          <div class="card mb-2">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col">
                  <p class="mb-2 ">Number of registered users</p>
                </div>
                <div class="col">
                  <p class="text-muted mb-2 text-center">{{$user->numberOfUserRegistered}}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <a class="text-muted mb-0" href="{{$user->referralLink}}">{{$user->referralLink}}</a>
                </div>
              </div>
            </div>
          </div>
